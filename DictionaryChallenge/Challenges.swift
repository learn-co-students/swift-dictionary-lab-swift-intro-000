...
//    
    ...
    func floridaCapital() -> String? {
        ...
        let capitals = self.createStatesAndCapitals()
...
//    "Unable to find the capital of Florida."
    ...
    func createFloridaCapitalSentence() -> String {
        ...
        if let floridaCapital = self.floridaCapital() {
...
//    "Unable to find the capital of Pennsylvania."
    ...
    func createPennsylvaniaSentence() -> String {
        ...
        if let pennCapital = self.pennsylvaniaCapital() {
...
//    
    ...
    func createAllStatesAndCapitals() -> [String: String] {
        ...
        var capitals = self.createStatesAndCapitals()
...
//    
    ...
    func removePennsylvania() -> [String: String] {
        ...
        var capitals = self.createAllStatesAndCapitals()
