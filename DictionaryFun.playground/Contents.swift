 ...
 */
var stateAndCapitals = ["New York": "Albany", "Ohio" : "Columbus", "Florida" : "Tallahassee", "Georgia" : "Atlanta", "Kentucky" : "Frankfort"]
 ...
 */
if let capitalOfPennsylvania = stateAndCapitals["Pennsylvania"] {
    print("Pennsylvania's capital is \(capitalOfPennsylvania)")
} else {
    print("I don't know Pennsylvania's capital")
}
...
stateAndCapitals["Pennsylvania"] = nil
print(stateAndCapitals)
 ...
 */
let state = "New York"
let nyCapital = stateAndCapitals[state]
 ...
 */
let bandAndTheirMembers = ["Nirvana" : ["Kurt Cobain", "Krist Novoselic", "Dave Grohl"],
                           "The Beatles" : ["John Lennon", "George Harrison", "Paul McCartney", "Ringo Starr"],
                           "The Breeders" : ["Kim Deal", "Kelley Deal", "Josephine Wiggs", "Jim Macpherson"],
                           "Pixies" : ["Frank Black", "Joey Santiago", "Kim Deal", "David Lovering"]
]
 ...
 */
let bandName = "Pixies"
let bandMembers = bandAndTheirMembers[bandName]
