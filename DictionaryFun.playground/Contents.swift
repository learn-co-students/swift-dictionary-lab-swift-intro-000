 ...
 */
var statesAndTheirCapitals = ["New York":"Albany", "Ohio":"Columbus", "Florida":"Tallahassee", "Georgia":"Atlanta", "Kentucky":"Frankfort"]
 ...
 */
let capital = statesAndTheirCapitals["Florida"]
 ...
 */
let anotherCapital = statesAndTheirCapitals["Pennsylvania"]
 ...
 */
statesAndTheirCapitals["Pennsylvania"] = "Harrisburg"
 ...
 */
if let capital = statesAndTheirCapitals["Pennsylvania"] {
    print("Pennsylvania capital is \(capital)")
}
 ...
 */
statesAndTheirCapitals["Pennsylvania"] = nil

print(statesAndTheirCapitals)
 ...
 */
let state = "New York"
if let capital = statesAndTheirCapitals[state] {
...
var bands = ["Nirvana": ["Kurt Cobain", "Krist Novoselic", "Dave Grohl"],
             "The Beatles": ["John Lennon", "George Harrison", "Paul McCartney", "Ringo Starr"],
             "The Breeders": ["Kim Deal", "Kim Deal", "Josephine Wiggs", "Jim Macpherson"],
             "Pixies": ["Frank Black", "Joey Santiago", "Kim Deal", "David Lovering"]
]
