 ...
 */
var stateCapital = ["New York": "Albany",
"Ohio": "Columbus",
"Florida": "Tallahassee",
"Georgia": "Atlanta",
"Kentucky": "Frankfort"]
 ...
 */
if let capital = stateCapital["Florida"] {
    print(capital)
}
 ...
 */
if let anotherCapital = stateCapital["Pennsylvania"] {
 ...
 */
if let capital = stateCapital["Pennsylvania"] {
...
if let capital = stateCapital[state] {
