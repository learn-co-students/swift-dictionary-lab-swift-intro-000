 ...
 */
var pennCap = statesAndCapitals["Pennsylvania"]
if let pennCap = pennCap {
    print("Pennsylvania's capital is \(pennCap)")
}
 ...
 */
let state = "New York"
var stateCap = statesAndCapitals[state]
print("The capital of \(state) is \(stateCap)")
 ...
 */
var bandInfo = ["Nirvana" : ["Kurt Cobain", "Krist Novoselic", "Dave Grohl"], "The Beatles" : ["John Lennon", "George Harrison", "Paul McCartney", "Ringo Starr"], "The Breeders" : ["Kim Deal", "Kelley Deal", "Josephine Wiggs", "Jim Macpherson"], "Pixies" : ["Frank Black", "Joey Santiago", "Kim Deal", "David Lovering"]]
