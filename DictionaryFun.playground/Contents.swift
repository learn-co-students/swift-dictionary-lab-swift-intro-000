 ...
 */
//This is a string key, string value dictionary.
 ...
 */
if let floridaCapital = capital {
    print("The capital of Florida is \(floridaCapital)")
}
 ...
 */
if let pennsylvaniaCapital = anotherCapital {
    print("The capital of Pennsylvania is \(pennsylvaniaCapital).")
} else {
 ...
 */
if let pennsylvaniaCapital = capitals["Pennsylvania"] {
...
if let newYorkCapital = capitals[state] {
...
if let pixiesMembers = bands[bandName] {
    print(pixiesMembers)
}
